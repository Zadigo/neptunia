...
# def receive_function(name=None, sender=None, **kwargs):
#     sender()
#     print(name, kwargs)
...
# signal = Signal()
# signal.connect(receive_function, sender=send_function)


# # @function_to_receiver(signal, sender=receive_function)
# # def converted_receiver(**kwargs):
# #     print('Converted function', kwargs)


# if __name__ == '__main__':
#     print('Started')
#     while True:
#         result = signal.send(send_function, name='Kendall Jenner')
#         # result = signal.send(receive_function, name='Kendall Jenner')
#         print('Result:', result)
#         time.sleep(5)
